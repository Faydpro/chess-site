          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex items-center space-x-4 mb-4">
                <span className="text-3xl font-bold text-amber-500">60€</span>
                <span className="text-lg text-gray-500 line-through">80€</span>
            ...
            <div className="space-y-4">
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div className={`mt-4 text-gray-600 dark:text-gray-400 transition-all duration-300 ${
                  openSection === 'description' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                }`}>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div className={`mt-4 text-gray-600 dark:text-gray-400 transition-all duration-300 ${
                  openSection === 'dimensions' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                }`}>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <div className={`mt-4 text-gray-600 dark:text-gray-400 transition-all duration-300 ${
                  openSection === 'shipping' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                }`}>
